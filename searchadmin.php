...
<div class="container">
  <br>
  <form class="input-group rounded example1" action="searchadmin.php">  
...
<div class="container">
        ...
        <div class="row">
          ...
          <div class="card">
          <a href="detailadmin.php?id=<?=$r['productid']?>">
            <img src="./img/<?=$r['pimage']?>" class="card-img-top" alt="...">
          </a>
            <div class="card-body">
          <a href="detailadmin.php?id=<?=$r['productid']?>"class="text-decoration-none"><h5 class="card-title"><?=$r['productname']?></h5></a>
          <h6 class="card-subtitle mb-2 text-muted"><?=$r['sellprice']?><span>&#8363;</span></h6>
          <br>
          <a href="cartadmin.php?id=<?=$r['productid']?>" class="btn btn-primary">Add to Cart</a>
            </div>
          </div>
          <br>
        </div>    
